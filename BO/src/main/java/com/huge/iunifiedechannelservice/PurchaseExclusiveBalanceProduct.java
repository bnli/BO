...
@XmlRootElement(name = "purchaseExclusiveBalanceProduct")
public class PurchaseExclusiveBalanceProduct {
	...
	protected PurchaseExclusiveBalanceProduct.PurchaseInfos purchaseInfos;
	@XmlElement(required = true)
	 ...
	 * 
	 */
	public PurchaseExclusiveBalanceProduct.PurchaseInfos getPurchaseInfos() {
	...
	public void setPurchaseInfos(
			PurchaseExclusiveBalanceProduct.PurchaseInfos value) {
