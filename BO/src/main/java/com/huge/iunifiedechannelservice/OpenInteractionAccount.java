 ...
 *         &lt;element name="smartCardNo" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = { "commonTradeInfo", "customerCode",
		"smartCardNo" })
@XmlRootElement(name = "openInteractionAccount")
public class OpenInteractionAccount {
	...
	/**
	 * Gets the value of the smartCardNo property.
	 * 
	 * @return possible object is {@link String }
	 * 
	 */
	...
	/**
	 * Sets the value of the smartCardNo property.
	 * 
	 * @param value
	 *            allowed object is {@link String }
	 * 
	 */
	public void setSmartCardNo(String value) {
		this.smartCardNo = value;
	}
